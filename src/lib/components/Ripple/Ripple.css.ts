import { anim, varBook } from '$utils/format';
...
export const ripple = style({
	...
	animation: anim(
		[
			svelteVars.opacityDuration,
			svelteVars.opacityEasing,
			svelteVars.opacityDelay,
			1,
			fade,
			'forwards',
		],
		[
			svelteVars.spreadDuration,
			svelteVars.spreadEasing,
			svelteVars.spreadDelay,
			1,
			spread,
			'forwards',
		],
		[
			svelteVars.colorDuration,
			svelteVars.colorEasing,
			svelteVars.colorDelay,
			1,
			color,
			'forwards',
		]
